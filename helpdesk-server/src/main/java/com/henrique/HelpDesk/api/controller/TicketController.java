package com.henrique.HelpDesk.api.controller;

import com.henrique.HelpDesk.api.dto.Summary;
import com.henrique.HelpDesk.api.response.Response;
...
import com.henrique.HelpDesk.api.security.enums.StatusEnum;
import com.henrique.HelpDesk.api.security.jwt.JwtTokenUtil;
import com.henrique.HelpDesk.api.service.TicketService;
import com.henrique.HelpDesk.api.service.UserService;
    ...
    public ResponseEntity<Response<Summary>> findSummary() {
        ...
        if (tickets != null) {
            for (Iterator<Ticket> iterator = tickets.iterator(); iterator.hasNext();) {
                ...
                if (ticket.getStatus().equals(StatusEnum.Assiged)) {
                    amountAssigned++;
                }
